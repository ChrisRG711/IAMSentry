...
class TestValidationMixin:
    ...
    def test_blocklist_validation_blocks_project(self):
        ...
        processor.init_validation_config({
            'blocklist_projects': ['blocked-project']
        })

        result = processor.validate_blocklist(
            'blocked-project',
            'user@example.com',
            'user'
        )
    ...
    def test_safety_score_validation(self):
        ...
        processor = TestProcessor()
        processor.init_validation_config({
            'min_safe_to_apply_score_user': 70
        })
    ...
    def test_critical_account_detection(self):
        ...
        assert processor.is_critical_account('prod-deployer@project.iam.gserviceaccount.com') is True
...
class TestIAMPolicyModifier:
    ...
    def test_remove_member(self):
        ...
        updated = IAMPolicyModifier.remove_member(
    ...
    def test_add_member_to_existing_role(self):
        ...
        updated = IAMPolicyModifier.add_member(
            policy, 'roles/editor', 'user:bob@example.com'
        )
    ...
    def test_add_member_to_new_role(self):
        ...
        updated = IAMPolicyModifier.add_member(
            policy, 'roles/viewer', 'user:bob@example.com'
        )
    ...
    def test_replace_role(self):
        ...
        assert editor_binding is None or 'user:alice@example.com' not in editor_binding.get('members', [])
    ...
    def test_get_member_roles(self):
        ...
        policy = {
            'bindings': [
                ...
                {'role': 'roles/viewer', 'members': ['user:alice@example.com', 'user:bob@example.com']},
